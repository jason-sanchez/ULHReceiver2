...
Public Class Form1
    ...
    Private fullinipath As String = Path.GetFullPath(Path.Combine(Directory.GetCurrentDirectory, "..\..\..\Configs\ULH\HL7Receiver.ini")) ' New test
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strInputDirectory = dir & parent & objIniFile.GetString("Settings", "root", "(none)") ' d:\W3feeds\HL7
        strProblemDirectory = dir & parent & objIniFile.GetString("Settings", "problemfiles", "(none)") '20140910 - d:\problems

        port = objIniFile.GetInteger("Settings", "port", "(0)") ' 2201
        strLogDirectory = dir & parent & objIniFile.GetString("Settings", "logs", "(none)") '20140921
